    ...
    <section className="relative">
      ...
      <div className="relative h-[70vh] flex items-center justify-center text-center">
        ...
        <div className="relative z-10 px-6">
          ...
          <a
            href="#apply"
            className="mt-8 inline-block px-8 py-3 bg-yellow-400 text-gray-900 font-semibold rounded-lg shadow hover:bg-yellow-500 transition"
          >
            Apply Now
          </a>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20 py-20 space-y-28">
        ...
        <section className="bg-gradient-to-r from-blue-50 to-white p-10 rounded-2xl shadow-lg">
          <h2 className="text-4xl font-bold text-blue-800 mb-6 flex items-center gap-2">
            <HeartHandshake className="w-8 h-8 text-blue-600" /> What You Get with Ramesh Group
          </h2>
        ...
        {/* Why Choose */}
        <section>
          <h2 className="text-4xl font-bold text-center text-blue-800 mb-12">Why Thousands Choose Us</h2>
        ...
        <section className="bg-gradient-to-r from-blue-50 to-blue-100 p-10 rounded-2xl shadow-lg">
          <h2 className="text-4xl font-bold text-blue-800 mb-6">Candidate Requirements</h2>
        ...
        <section className="bg-gradient-to-r from-green-50 via-white to-green-100 p-10 rounded-2xl shadow-lg">
          <h2 className="text-4xl font-bold text-center text-green-700 mb-8">
            <CheckCircle2 className="inline-block w-8 h-8 text-green-600" /> Benefits & Guarantees
          </h2>
          <ul className="grid md:grid-cols-2 gap-4 text-gray-800 font-medium">
            {benefits.map((b, i) => (
              <li key={i} className="flex gap-2 items-start">
        ...
        {/* Process Steps */}
        <section>
          <h2 className="text-4xl font-bold text-center text-blue-800 mb-12">Full Employment Process</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {steps.map((s, i) => (
              ...
              >
                <h4 className="text-lg font-semibold text-blue-700 mb-2">{s.title}</h4>
        ...
        <section>
          <h2 className="text-4xl font-bold text-center text-blue-800 mb-12">
            <HelpCircle className="inline-block w-8 h-8 text-purple-600" /> Frequently Asked Questions
          </h2>
        ...
        >
          ...
          <p className="mb-6 text-lg">
            Apply now with <span className="font-semibold">KonnectHRC</span> and Cohen Employment
            Group to secure your{" "}
